...
const HomeContent = memo(() => {
    ...
    return (
        ...
        >
            <div
                className="flex flex-col justify-center w-full xs:max-w-[400px] sm:max-w-[486px] max-w-[320px] mx-auto text-white/80 dark:text-gray-800">
                <div
                    className="flex justify-center mx-auto xs:p-3 xs:mb-4 p-3 mb-4 w-full rounded-md bg-white/5 dark:bg-white/40 backdrop-blur-lg">
                    {t("welcome")}
                </div>
